...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cycle_Selector = QtWidgets.QComboBox(Form)
        self.cycle_Selector.setObjectName("cycle_Selector")
        self.cycle_Selector.addItem("")
        self.cycle_Selector.addItem("")
        self.main_VerticalLayout.addWidget(self.cycle_Selector)
        ...
        self.label_HeatAdded = QtWidgets.QLabel(self.gb_Output)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_HeatAdded.sizePolicy().hasHeightForWidth())
        self.label_HeatAdded.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_HeatAdded.setFont(font)
        self.label_HeatAdded.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_HeatAdded.setObjectName("label_HeatAdded")
        self.grid_Output.addWidget(self.label_HeatAdded, 3, 3, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.label_T4.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_T4.setObjectName("label_T4")
        self.grid_Output.addWidget(self.label_T4, 4, 0, 1, 1)
        ...
        self.label_EfficiencyUnits = QtWidgets.QLabel(self.gb_Output)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_EfficiencyUnits.sizePolicy().hasHeightForWidth())
        self.label_EfficiencyUnits.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_EfficiencyUnits.setFont(font)
        self.label_EfficiencyUnits.setObjectName("label_EfficiencyUnits")
        self.grid_Output.addWidget(self.label_EfficiencyUnits, 4, 5, 1, 1)
        ...
        self.label_CompressionStroke = QtWidgets.QLabel(self.gb_Output)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_CompressionStroke.sizePolicy().hasHeightForWidth())
        self.label_CompressionStroke.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_CompressionStroke.setFont(font)
        self.label_CompressionStroke.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_CompressionStroke.setObjectName("label_CompressionStroke")
        self.grid_Output.addWidget(self.label_CompressionStroke, 2, 3, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.label_T1.setFocusPolicy(QtCore.Qt.WheelFocus)
        ...
        self.grid_Output.addWidget(self.label_T1, 0, 0, 1, 1)
        ...
        self.label_PowerStroke = QtWidgets.QLabel(self.gb_Output)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_PowerStroke.sizePolicy().hasHeightForWidth())
        self.label_PowerStroke.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_PowerStroke.setFont(font)
        self.label_PowerStroke.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_PowerStroke.setObjectName("label_PowerStroke")
        self.grid_Output.addWidget(self.label_PowerStroke, 0, 3, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.grid_Output.addWidget(self.label_T2, 2, 0, 1, 1)
        self.label_Efficiency = QtWidgets.QLabel(self.gb_Output)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_Efficiency.sizePolicy().hasHeightForWidth())
        self.label_Efficiency.setSizePolicy(sizePolicy)
        self.label_Efficiency.setMinimumSize(QtCore.QSize(250, 0))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_Efficiency.setFont(font)
        self.label_Efficiency.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_Efficiency.setObjectName("label_Efficiency")
        self.grid_Output.addWidget(self.label_Efficiency, 4, 3, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.label_T3.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_T3.setObjectName("label_T3")
        self.grid_Output.addWidget(self.label_T3, 3, 0, 1, 1)
        ...
        self.cycle_Selector.currentIndexChanged['int'].connect(Form.cycle_Selection)
        self.cycle_Selector.currentIndexChanged['int'].connect(Form.change_Units)
        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Form"))
        self.cycle_Selector.setItemText(0, _translate("Form", "Otto Cycle"))
        self.cycle_Selector.setItemText(1, _translate("Form", "Diesel Cycle"))
        ...
        self.label_HeatAdded.setText(_translate("Form", "Heat Added"))
        self.label_T4.setText(_translate("Form", "T4"))
        self.lbl_T4Units.setText(_translate("Form", "C"))
        self.lbl_PowerStrokeUnits.setText(_translate("Form", "kJ/kg"))
        self.label_EfficiencyUnits.setText(_translate("Form", "%"))
        ...
        self.label_CompressionStroke.setText(_translate("Form", "Compression Stroke"))
        self.label_T1.setText(_translate("Form", "T1"))
        self.label_PowerStroke.setText(_translate("Form", "Power Stroke"))
        self.label_T2.setText(_translate("Form", "T2"))
        self.label_Efficiency.setText(_translate("Form", "Cycle Efficiency"))
        self.lbl_T1Units.setText(_translate("Form", "C"))
        self.label_T3.setText(_translate("Form", "T3"))
